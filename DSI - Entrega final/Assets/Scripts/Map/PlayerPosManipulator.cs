...
public class PlayerPosManipulator : Manipulator
{
    private bool selected = true;
    VisualElement root; 

    public PlayerPosManipulator(VisualElement root) { this.root = root; }
    ...
    private void ChangeSelection(ClickEvent e)
    {
        ...
        List<VisualElement> vs = root.Query(className: "playerPos").ToList();
