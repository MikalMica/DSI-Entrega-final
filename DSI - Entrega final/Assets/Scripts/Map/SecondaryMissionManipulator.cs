...
public class SecondaryMissionManipulator : Manipulator
{
    private bool selected = true;
    VisualElement root;

    public SecondaryMissionManipulator(VisualElement root) { this.root = root; }
    ...
    private void ChangeSelection(ClickEvent e)
    {
        ...
        List<VisualElement> vs = root.Query(className: "secondaryMission").ToList();
